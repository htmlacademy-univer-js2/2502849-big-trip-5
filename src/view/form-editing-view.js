...
function createFormEditingTemplate({point, destination, offers}) {
  return `<form class="event event--edit" action="#" method="post">
            <header class="event__header">
              ...
              <div class="event__field-group  event__field-group--time">
                ...
                <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${formatDateTime(point.date_from)}">
                &mdash;
                <label class="visually-hidden" for="event-end-time-1">To</label>
                <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${formatDateTime(point.date_to)}">
              </div>
...
export default class FormEditingView extends AbstractView{
  ...
  constructor({point, destination, offers, onRollupButtonClick, onSubmit}) {
    super();
    this.#point = point;
    ...
    this.element.querySelector('.event__save-btn').addEventListener('submit', onSubmit);
  }
